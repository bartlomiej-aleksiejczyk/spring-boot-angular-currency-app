...
public class ExchangeRateController {
        ...
        @Operation(summary = "Retrieves the current exchange rate of a specified currency",
                        ...
                        responses = {@ApiResponse(responseCode = "200",
                                        ...
                                        content = @Content(mediaType = "application/json",
                                                        schema = @Schema(
                                                                        implementation = ExchangeRateResponseDTO.class),
        ...
        public ExchangeRateResponseDTO getCurrentCurrencyValue(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(
                                        description = "Currency code and name of requester user",
                                        required = true,
                                        content = @Content(mediaType = "application/json",
                                                        schema = @Schema(
                                                                        implementation = ExchangeRateRequestDTO.class),
                        ...
                        responses = {@ApiResponse(responseCode = "200",
                                        ...
                                        content = @Content(mediaType = "application/json",
                                                        array = @ArraySchema(schema = @Schema(
                                                                        implementation = ExchangeRateQueryDTO.class))))})
